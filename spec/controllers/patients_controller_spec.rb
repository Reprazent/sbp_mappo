...
describe PatientsController do
  ...
  def mock_patient(stubs={})
    @mock_patient ||= mock_model(Patient, stubs).as_null_object
  end

  describe "GET index" do
    it "assigns all patients as @patients" do
      Patient.stub(:all) { [mock_patient] }
      get :index
      assigns(:patients).should eq([mock_patient])
    end
  end

  describe "GET show" do
    it "assigns the requested patient as @patient" do
      Patient.stub(:find).with("37") { mock_patient }
      get :show, :id => "37"
      assigns(:patient).should be(mock_patient)
    end
  end

  describe "GET new" do
    it "assigns a new patient as @patient" do
      Patient.stub(:new) { mock_patient }
      get :new
      assigns(:patient).should be(mock_patient)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "assigns a newly created patient as @patient" do
        Patient.stub(:new).with({'these' => 'params'}) { mock_patient(:save => true) }
        post :create, :patient => {'these' => 'params'}
        assigns(:patient).should be(mock_patient)
      end

      it "redirects to the created patient" do
        Patient.stub(:new) { mock_patient(:save => true) }
        post :create, :patient => {}
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved patient as @patient" do
        Patient.stub(:new).with({'these' => 'params'}) { mock_patient(:save => false) }
        post :create, :patient => {'these' => 'params'}
        assigns(:patient).should be(mock_patient)
      end

      it "re-renders the 'new' template" do
        Patient.stub(:new) { mock_patient(:save => false) }
        post :create, :patient => {}
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "assigns the requested patient as @patient" do
        Patient.stub(:find) { mock_patient(:update_attributes => true) }
        put :update, :id => "1"
        assigns(:patient).should be(mock_patient)
      end
    ...
    describe "with invalid params" do
      it "assigns the patient as @patient" do
        Patient.stub(:find) { mock_patient(:update_attributes => false) }
        put :update, :id => "1"
        assigns(:patient).should be(mock_patient)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the patients list" do
      Patient.stub(:find) { mock_patient }
      delete :destroy, :id => "1"
